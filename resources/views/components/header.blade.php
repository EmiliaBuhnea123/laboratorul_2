...
<nav class=" bg-slate-600 text-white p-2.5">
    ...
    <ul class="list-none p-0 flex space-x-16">
        ...
        <li><a href="{{ route('tasks.create') }}" class="text-white no-underline hover:underline">Adaugă Sarcină</a></li>
        <li><a href="{{ route('tasks.index') }}" class="text-white no-underline hover:underline">Lista Sarcini</a></li>
    </ul>
</nav>
</div>
